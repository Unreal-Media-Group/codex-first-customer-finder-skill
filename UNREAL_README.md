...
prospecting data model. No SQL, migration, database connection, API, service, UI, runner, schedule,
creative, likeness use, advertisement, or outreach has been built or authorized. Phase 1 local usage
