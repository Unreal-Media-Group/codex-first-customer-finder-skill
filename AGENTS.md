...
- The manifest preserves the exhausted CELSIUS/Jazwares and 4ocean/Badia routes for durable
  historical validation. None of their URLs may be read again under the spent authorities. Only the
  exact TUUCI/Miansai v3 route is current, and each target is single-attempt after durable
  result-bound authority. Every scrubbed real dossier and
