...
- The authorized Phase 6B contract-first work may model only synthetic business people, roles,
  ...
  Jazwares leadership URL is not current authority, and the current 4ocean/Badia plans add no public
  person source. Every other live public-person read requires new exact authorization. Limit person
...
- The manifest preserves the exhausted CELSIUS/Jazwares route for durable historical validation and
  the current 4ocean/Badia route for the newly authorized proof. Historical URLs may not be read
  again; current URLs may be read only once through their exact result-bound authority. Any later
  proof requires new exact URLs and durable result-bound authority. Every scrubbed real dossier and
