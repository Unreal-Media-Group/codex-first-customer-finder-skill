...
- The manifest preserves the exhausted CELSIUS/Jazwares, 4ocean/Badia, and TUUCI/Miansai routes for
  ...
  The default runtime has no executable real-proof route; any future proof requires a newly
  authorized exact target, URLs, source classes, versioned route, and durable result-bound authority.
